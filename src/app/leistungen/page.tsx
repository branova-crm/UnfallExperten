            ...
            <section className="cta-banner">
                ...
                <div className="container">
                    ...
                    <div className="cta-banner-buttons">
                        <a href="tel:+4902111234567" className="btn btn-accent">
                ...
                <div className="container">
                    <div className="contact-grid">
                        ...
                        <form className="contact-form callback-form" noValidate>
                            ...
                            <div className="form-group"><label htmlFor="message">Nachricht / Erreichbarkeit</label><textarea id="message" name="message" placeholder="Wann können wir Sie am besten erreichen?" rows={4}></textarea></div>
                            <button type="submit" className="btn btn-primary form-submit">Rückruf anfordern</button>
                            <p className="form-dsgvo">Mit dem Absenden stimmen Sie der Verarbeitung Ihrer Daten gemäß unserer <a href="#" style={{ color: 'var(--clr-accent)', textDecoration: 'underline' }}>Datenschutzerklärung</a> zu. Ihre Daten werden ausschließlich zur Kontaktaufnahme verwendet.</p>
                        </form>
                    </div>
                </div>
            </section>
