...
export const metadata: Metadata = {
    ...
    description: 'Kfz-Kostenvoranschlag in NRW – ideal für Bagatellschäden. Versteckte Schäden aufdecken, faire Schadensregulierung sichern. Jetzt kostenlos anfragen!',
};
        ...
        <>
            <section className="page-hero">
                <div className="container">
                    <p className="breadcrumb"><Link href="/">Startseite</Link> / <Link href="/leistungen">Leistungen</Link> / Kostenvoranschlag</p>
                    <h1>Kostenvoranschlag</h1>
                    <p>Effiziente und präzise Schadensbewertung – ideal für Bagatellschäden unter 750 €.</p>
                ...
                <div className="container">
                    <div className="contact-grid">
                        ...
                        <form className="contact-form callback-form" noValidate>
                            ...
                            <div className="form-group"><label htmlFor="message">Nachricht</label><textarea id="message" name="message" placeholder="Ich benötige einen Kostenvoranschlag für..." rows={4}></textarea></div>
