    ...
    <>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Unabhängige Gutachten für Teil- und Vollkaskoschäden – damit Sie
                die faire Entschädigung erhalten, die Ihnen zusteht.
              </p>
              <div
                className="hero-ctas"
      ...
      <section className="content-section">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Bei Kaskoschäden setzt Ihre Versicherung oft eigene Gutachter ein,
              die den Schaden tendenziell niedrig bewerten. Ein unabhängiges
              Gutachten von UnfallExperten NRW stellt sicher, dass Sie den
              fairen Ausgleich erhalten.
            </p>
      ...
      <section className="content-section alt">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Hat Ihre Versicherung ein unzureichendes Angebot gemacht? Wir
              unterstützen Sie bei der Anfechtung und liefern die fachliche
              Grundlage für Ihre Nachforderung.
            </p>
            <ul className="check-list" style={{ alignItems: "center" }}>
              <li>Unabhängige Gegenbewertung zum Versicherungsgutachten</li>
              <li>Präzise Dokumentation aller Schäden mit Fotobeweis</li>
              <li>
                Unterstützung bei der Korrespondenz mit Ihrer Versicherung
              </li>
              <li>
                Ermittlung des tatsächlichen Wiederbeschaffungs- und Restwerts
              </li>
            </ul>
            <p>
              Unser Ziel: Sie erhalten die Entschädigung, die Ihnen tatsächlich
              zusteht – nicht weniger.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cta-banner">
        ...
        <div className="container">
          ...
          <p>
            Lassen Sie Ihren Kaskoschaden unabhängig bewerten – für die faire
            Entschädigung.
          </p>
        ...
        <div className="container">
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <p>
                Wir beraten Sie zu Ihrem Kaskoschaden und erstellen ein
