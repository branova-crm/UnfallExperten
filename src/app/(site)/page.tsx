        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-ctas">
              ...
              <Link href="https://wa.me/4902111234567?text=Hallo%2C%20ich%20brauche%20Hilfe%20nach%20einem%20Unfall." className="btn btn-whatsapp hero-cta-btn" target="_blank">
              ...
              <div className="hero-trust-rating">
                <div className="hero-trust-avatars">
                    {[
                      ...
                      <span key={i} className="hero-trust-avatar" style={{ background: a.bg, zIndex: 5 - i }}>
                        {a.init}
                      </span>
                    ))}
                </div>
                <span className="hero-trust-rating-text">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="#FBBC05" aria-hidden="true"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" /></svg>
                    5.0 Google · 8 Bewertungen
                </span>
              </div>
  
              <ul className="trust-list hero-trust-list">
                <li><span className="check" aria-hidden="true">✓</span> Keine Kosten für Geschädigte</li>
                <li><span className="check" aria-hidden="true">✓</span> Einsatz in ganz NRW – sofort verfügbar</li>
                <li><span className="check" aria-hidden="true">✓</span> Gutachten in 24 Stunden</li>
              </ul>
            </div>
        </div>
          ...
          <div className="regional-grid">
            <div>
              ...
              <div className="location-badge-grid home-location-grid">
                ...
                <Link href="/standorte" className="location-pill location-pill--link">
                  <div className="pill-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                      <circle cx="12" cy="10" r="3"></circle>
                  ...
                  <div className="pill-content">
                    ...
                    <span className="pill-time">Alle Städte &amp; Einsatzgebiete</span>
                  </div>
                </Link>
              </div>
            </div>
