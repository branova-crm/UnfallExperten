...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Heimerzheim', time: 'ca. 20 Min vor Ort' },
      { city: 'Odendorf', time: 'ca. 15 Min vor Ort' },
      { city: 'Buschhoven', time: 'ca. 20 Min vor Ort' },
      { city: 'Ludendorf', time: 'ca. 15 Min vor Ort' },
      { city: 'Morenhoven', time: 'ca. 20 Min vor Ort' },
      { city: 'Miel', time: 'ca. 20 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Swisttal und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Swisttal auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
