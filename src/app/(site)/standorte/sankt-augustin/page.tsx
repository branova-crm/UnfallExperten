...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Hangelar', time: 'ca. 45 Min vor Ort' },
      { city: 'Menden', time: 'ca. 40 Min vor Ort' },
      { city: 'Niederpleis', time: 'ca. 45 Min vor Ort' },
      { city: 'Mülldorf', time: 'ca. 45 Min vor Ort' },
      { city: 'Buisdorf', time: 'ca. 45 Min vor Ort' },
      { city: 'Birlinghoven', time: 'ca. 50 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Sankt Augustin und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Sankt Augustin auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
