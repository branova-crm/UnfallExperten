...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Hennef-Zentrum', time: 'ca. 45 Min vor Ort' },
      { city: 'Uckerath', time: 'ca. 50 Min vor Ort' },
      { city: 'Geistingen', time: 'ca. 45 Min vor Ort' },
      { city: 'Warth', time: 'ca. 45 Min vor Ort' },
      { city: 'Happerschoß', time: 'ca. 50 Min vor Ort' },
      { city: 'Bödingen', time: 'ca. 50 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Hennef und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Hennef auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
