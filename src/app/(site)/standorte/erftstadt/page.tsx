...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Lechenich', time: 'ca. 20 Min vor Ort' },
      { city: 'Liblar', time: 'ca. 25 Min vor Ort' },
      { city: 'Gymnich', time: 'ca. 25 Min vor Ort' },
      { city: 'Dirmerzheim', time: 'ca. 25 Min vor Ort' },
      { city: 'Kierdorf', time: 'ca. 25 Min vor Ort' },
      { city: 'Köttingen', time: 'ca. 25 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Erftstadt und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Erftstadt auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
