...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Oberpleis', time: 'ca. 50 Min vor Ort' },
      { city: 'Heisterbacherrott', time: 'ca. 45 Min vor Ort' },
      { city: 'Ittenbach', time: 'ca. 50 Min vor Ort' },
      { city: 'Thomasberg', time: 'ca. 50 Min vor Ort' },
      { city: 'Niederdollendorf', time: 'ca. 45 Min vor Ort' },
      { city: 'Königswinter-Altstadt', time: 'ca. 45 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Königswinter und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Königswinter auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
