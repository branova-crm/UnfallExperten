...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Altendorf', time: 'ca. 25 Min vor Ort' },
      { city: 'Ersdorf', time: 'ca. 20 Min vor Ort' },
      { city: 'Lüftelberg', time: 'ca. 25 Min vor Ort' },
      { city: 'Merl', time: 'ca. 20 Min vor Ort' },
      { city: 'Meckenheim-Zentrum', time: 'ca. 20 Min vor Ort' },
      { city: 'Neuem', time: 'ca. 20 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Meckenheim und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Meckenheim auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
