...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Euskirchen-Innenstadt', time: 'ca. 5 Min vor Ort' },
      { city: 'Kuchenheim', time: 'ca. 10 Min vor Ort' },
      { city: 'Flamersheim', time: 'ca. 15 Min vor Ort' },
      { city: 'Stotzheim', time: 'ca. 10 Min vor Ort' },
      { city: 'Roitzheim', time: 'ca. 5 Min vor Ort' },
      { city: 'Wißkirchen', time: 'ca. 10 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Euskirchen und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Euskirchen auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
