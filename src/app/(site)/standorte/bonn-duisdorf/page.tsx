...
export default function StandortDetail() {
  const data: StandortData = {
    ...
    areas: [
      ...
      { city: 'Duisdorf-Mitte', time: 'ca. 30 Min vor Ort' },
      { city: 'Hardtberg', time: 'ca. 30 Min vor Ort' },
      { city: 'Lengsdorf', time: 'ca. 30 Min vor Ort' },
      { city: 'Lessenich/Meßdorf', time: 'ca. 30 Min vor Ort' },
      { city: 'Medinghoven', time: 'ca. 30 Min vor Ort' },
      { city: 'Ückesdorf', time: 'ca. 30 Min vor Ort' },
        ],
    otherCities: [
    ...
    faqs: [
      ...
      { q: 'Sind Sie in allen Stadtteilen von Bonn-Duisdorf und Umgebung mobil im Einsatz?', a: 'Selbstverständlich. Wir begutachten Fahrzeuge im gesamten Stadtgebiet und näheren Umkreis ohne zusätzliche Anfahrtskosten.' },
      ...
      { q: 'Führen Sie Begutachtungen in Bonn-Duisdorf auch am Wochenende durch?', a: 'Da ein Autounfall keine Bürozeiten kennt, bieten wir Ihnen einen durchgehenden 24/7-Notfallservice. Dadurch stellen wir sicher, dass Sie auch an Wochenenden oder Feiertagen schnelle fachmännische Hilfe erhalten.' },
