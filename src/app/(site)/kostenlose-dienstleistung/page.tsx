    ...
    <>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Kompletter Unfallservice für Geschädigte – von der Begutachtung
                bis zur Auszahlung. Für Sie komplett kostenlos.
              </p>
              <div
                className="hero-ctas"
      ...
      <section className="content-section">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Unfall gehabt? Egal ob Tag oder Nacht, Wochentag oder Wochenende –
              wir sind rund um die Uhr für Sie erreichbar. Über Telefon oder
              WhatsApp erreichen Sie uns sofort und wir leiten alle notwendigen
              Schritte ein.
            </p>
            <p>
              Das Beste:{" "}
              <strong>
                Alle unsere Leistungen sind für Unfallgeschädigte komplett
                kostenlos.
              </strong>{" "}
              Die Kosten übernimmt in der Regel die gegnerische
              Haftpflichtversicherung. Sie haben keinerlei finanzielles Risiko.
            </p>
      ...
      <section className="content-section alt">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Wir kümmern uns um den gesamten Prozess nach Ihrem Unfall – damit
              Sie sich auf das Wesentliche konzentrieren können:
            </p>
            <ul className="check-list" style={{ alignItems: "center" }}>
              <li>
                Professionelles Unfallgutachten durch Experten für KFZ-Schäden
              </li>
      ...
      <section className="content-section">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Wir arbeiten transparent und in Ihrem Interesse. Unsere
              unabhängigen Sachverständigen haben jahrelange Erfahrung in der
              Unfallabwicklung und kennen alle Tricks der Versicherungen.
            </p>
            <ul className="check-list" style={{ alignItems: "center" }}>
      ...
      <section className="cta-banner">
        ...
        <div className="container">
          ...
          <p>
            Wir übernehmen alles – Sie lehnen sich zurück. Jetzt unverbindlich
            anfragen.
          </p>
        ...
        <div className="container">
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <p>
                Rufen Sie an oder hinterlassen Sie Ihre Nummer – wir helfen
                Ihnen sofort.
              </p>
