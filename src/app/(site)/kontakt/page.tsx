                        ...
                        <div className="contact-info">
                            ...
                            <div style={{ marginTop: 'var(--sp-xl)', padding: 'var(--sp-lg)', background: 'var(--clr-offwhite)', borderRadius: 'var(--radius)', textAlign: 'center' }}>
                                <p style={{ fontSize: 'var(--fs-sm)', color: 'var(--clr-text-muted)', margin: 0 }}>
                                    <strong style={{ color: 'var(--clr-primary)' }}><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '6px' }}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> NRW-weit im Einsatz</strong><br />
