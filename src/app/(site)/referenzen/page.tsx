    ...
    <>
        ...
        <section className="hero" style={{ minHeight: "85vh" }}>
          ...
          >
            ...
            >
              ...
              >
                Einblicke in echte Gutachtenfälle – transparent dargestellt,
                damit Sie einschätzen können, wie wir Schäden bewerten und
                dokumentieren.
              </p>
            </div>
          </div>
      ...
      <section className="content-section">
        <div className="container">
          <div
            ...
            style={{ maxWidth: "720px", margin: "0 auto var(--sp-2xl)" }}
          >
            <span
            ...
            <p className="section-subtitle mx-auto">
              Fahrzeugbilder aus realen Gutachten meiner Kunden. Klicken Sie auf
              ein Bild, um es zu vergrößern.
            </p>
          </div>
          <ReferenzenGallery />
        </div>
      ...
      <section className="cta-banner">
        ...
        <div className="container">
          ...
          <p>
            Wir begutachten Ihr Fahrzeug schnell und unabhängig – für
            Geschädigte in der Regel kostenlos.
          </p>
          <div className="cta-banner-buttons">
            <Link href="/kontakt" className="btn btn-outline">
              Kontakt aufnehmen
            </Link>
            <a href="tel:+4902111234567" className="btn btn-primary">
              Jetzt anrufen
            </a>
          </div>
        </div>
