        ...
        <section className="hero" style={{ minHeight: "85vh" }}>
          ...
          >
            ...
            >
              ...
              >
                Effiziente und präzise Schadensbewertung – ideal für
      ...
      <section className="content-section">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Bei kleineren Schäden (sogenannten Bagatellschäden unter 750 €)
              reicht in vielen Fällen ein Kostenvoranschlag statt eines
              vollständigen Gutachtens. Wir erstellen für Sie eine detaillierte
              Kostenkalkulation, die alle erforderlichen Reparaturarbeiten und
              Materialkosten erfasst.
            </p>
            <p>
              Ein professioneller Kostenvoranschlag bietet Ihnen eine solide
              Grundlage für die Schadensregulierung mit der Versicherung – auch
              ohne ein aufwendiges Gutachten.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="content-section alt">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Was auf den ersten Blick wie ein kleiner Kratzer aussieht, kann
              dahinter liegende Strukturschäden verbergen. Unsere
              Sachverständigen prüfen jeden Schaden gründlich, damit keine
              versteckten Kosten übersehen werden.
            </p>
            <ul className="check-list" style={{ alignItems: "center" }}>
              ...
              <li>
                Empfehlung eines Gutachtens, wenn die Schadenshöhe die
                Bagatellgrenze übersteigt
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="content-section">
        <div className="container" style={{ maxWidth: "800px" }}>
          <div className="content-text text-center">
            ...
            <p>
              Unser detaillierter Kostenvoranschlag dient als Basis für die
              Schadensregulierung. Wir begleiten Sie auch bei der Kommunikation
              mit der gegnerischen Versicherung und sorgen dafür, dass alle Ihre
        ...
        <div className="container">
          <div className="contact-grid">
            <div className="contact-info">
              ...
              <p>
                Wir beraten Sie, ob ein Kostenvoranschlag oder ein Gutachten für
                Ihren Fall die bessere Wahl ist.
              </p>
