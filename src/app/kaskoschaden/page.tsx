        ...
        <>
            <section className="page-hero">
                <div className="container">
                    <p className="breadcrumb"><Link href="/">Startseite</Link> / <Link href="/leistungen">Leistungen</Link> / Kaskoschäden</p>
                    <h1>Kaskoschäden</h1>
                    <p>Unabhängige Gutachten für Teil- und Vollkaskoschäden – damit Sie die faire Entschädigung erhalten, die Ihnen zusteht.</p>
