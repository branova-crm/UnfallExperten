...
export default function StandortPageTemplate({ data }: { data: StandortData }) {
  const { city, slug, heroSubline, introParagraph, areas, otherCities, faqs } =
    data;
    ...
    <div className="standort-detail-page">
        ...
        <section className="hero" style={{ minHeight: "85vh" }}>
          ...
          >
            ...
            >
              ...
              >
                {heroSubline ||
                  `Schnelle Schadensbegutachtung direkt bei Ihnen vor Ort in ${city} – kostenlos für Unfallgeschädigte.`}
              </p>
              <div
                className="hero-ctas"
                style={{
      ...
      {introParagraph && (
        <section
          ...
          style={{ padding: "var(--sp-2xl) 0", background: "var(--clr-white)" }}
        >
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    gap: "15px",
                    padding: "15px 20px",
                    background: "var(--clr-offwhite, #f8f9fa)",
                    borderRadius: "8px",
                ...
                <a
                  href="mailto:info@unfallexperten-nrw.de"
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: "15px",
          ...
          <div className="container">
            <div className="text-center">
              ...
              <h2 className="section-title">
                Schnell bei Ihnen in {city} und Umgebung
              </h2>
            </div>
            <div
              className="location-badge-grid"
              style={{
                marginTop: "var(--sp-xl)",
                display: "grid",
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: "1.05rem", lineHeight: 1.5 }}>
                    ...
                    für Sie bei unverschuldeten Unfällen
                  </span>
                </li>
                <li
                  style={{
                ...
                >
                  ...
                  <span style={{ fontSize: "1.05rem", lineHeight: 1.5 }}>
                    ...
                    inkl. Anwalt- und Werkstattvermittlung
                  </span>
                </li>
                <li
                  style={{
                ...
                >
                  ...
                  <span style={{ fontSize: "1.05rem", lineHeight: 1.5 }}>
                    ...
                    für präzise Wiederbeschaffungswerte in {city}
                  </span>
                </li>
              </ul>
            </div>
      ...
      >
        <div className="container">
          <h2 style={{ color: "#fff", marginBottom: "15px" }}>
            Stressfreie Regulierung – Wir kümmern uns um alles
          </h2>
                ...
                >
                    ...
                    <span
                      ...
                      style={{
                        ...
                        border:
                          activeIndex === i
                            ? "none"
                            : "1px solid rgba(var(--clr-primary-rgb, 13, 40, 104), 0.2)",
                      }}
                    >
                      <svg
                        viewBox="0 0 24 24"
                  ...
                  <div className="faq-answer">
                    <div
                      ...
                      style={{ color: "#555", paddingBottom: "20px" }}
                    >
                      {faq.a}
                    </div>
                  </div>
