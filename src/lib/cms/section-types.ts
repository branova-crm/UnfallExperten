...
export const PAGE_TEMPLATES: PageTemplate[] = [
    {
        ...
        sections: [
            ...
            createSection('CTA_BANNER', { label: 'CTA Banner', settings: { ...defaultSettings(), background: { ...defaultSettings().background, type: 'color', color: '#0f2f7a' }, spacing: { paddingTop: 40, paddingRight: 20, paddingBottom: 40, paddingLeft: 20, marginTop: 0, marginBottom: 0 } }, advanced: { ...defaultAdvanced(), anchorId: 'cta' } }),
        ],
    },
    {
        ...
        sections: [
            ...
            createSection('CTA_BANNER', { label: 'CTA', settings: { ...defaultSettings(), background: { ...defaultSettings().background, type: 'color', color: '#0f2f7a' }, spacing: { paddingTop: 45, paddingRight: 20, paddingBottom: 45, paddingLeft: 20, marginTop: 0, marginBottom: 0 } }, data: { headline: 'Jetzt Kontakt aufnehmen', text: 'Senden Sie uns die Infos – wir melden uns umgehend.', ctaText: 'WhatsApp starten', ctaLink: 'https://wa.me/49XXXXXXXXXX', secondaryCtaText: 'Kontaktformular', secondaryCtaLink: '/kontakt' } }),
        ],
    },
    {
        ...
        sections: [
            ...
            createSection('CTA_BANNER', { label: 'CTA', settings: { ...defaultSettings(), background: { ...defaultSettings().background, type: 'color', color: '#0f2f7a' }, spacing: { paddingTop: 45, paddingRight: 20, paddingBottom: 45, paddingLeft: 20, marginTop: 0, marginBottom: 0 } }, data: { headline: 'Kontakt aufnehmen', text: 'Senden Sie uns Ihre Anfrage – wir melden uns.', ctaText: 'Kontakt', ctaLink: '/kontakt', secondaryCtaText: 'WhatsApp', secondaryCtaLink: 'https://wa.me/49XXXXXXXXXX' } }),
        ],
    },
    {
    ...
    },
    {
        ...
        sections: [
            ...
            createSection('CTA_BANNER', { label: 'CTA', settings: { ...defaultSettings(), background: { ...defaultSettings().background, type: 'color', color: '#0f2f7a' } }, data: { headline: 'Jetzt anfragen', text: 'Wir freuen uns auf Ihre Nachricht.', ctaText: 'Kontakt', ctaLink: '/kontakt', secondaryCtaText: '', secondaryCtaLink: '' } }),
        ],
    },
];
